...
class APIs {
  ...
  static Stream<QuerySnapshot<Map<String, dynamic>>> getAllGDMessages(
      String groupID) {
    return firestore
        .collection('group-chats/${groupID}/chat/')
        .orderBy('sent', descending: true)
        .snapshots();
  }
  ...
  // for sending message
  static Future<void> sendGDMessage(
    ...
    final ref = firestore.collection('group-chats/${groupID}/chat/');
  ...
  //Add a group
  static Future<void> addGroup(String groupName, String imageUrl) async {
    await firestore
        .collection('group-chats')
        .add({'group_name': groupName, 'display_image': imageUrl});
  }
